...
class FacultyProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: GuideServices.fetchGuideProfile(),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            InfoField(label: 'CONTACT NUMBER', value: profile.phone, icon: Icons.phone_outlined),
                            const SizedBox(height: 12),
                            InfoField(label: 'EMAIL ADDRESS', value: profile.email, icon: Icons.mail_outline),
                            const SizedBox(height: 12),
                            InfoField(label: 'DESIGNATION', value: profile.designation),
                            const SizedBox(height: 12),
                            InfoField(label: 'BRANCH', value: profile.department),
                            const SizedBox(height: 12),
